...
df <- read_csv("Исходные Данные\\Использование\\World Vehicles in Use.csv")
...
df_long$Volume <- df_long$Volume / 1000
df_long$Unit <- "mln units"

fwrite(df_long, file = "Обработанные Данные\\Использование\\usage-countries.tsv", sep = "\t", quote = FALSE)
