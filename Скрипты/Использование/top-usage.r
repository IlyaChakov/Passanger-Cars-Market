...
df <- read_tsv("Обработанные Данные\\Использование\\usage-countries.tsv")
...
fwrite(table_top_10, file = "Итоговые Таблицы\\Использование\\top-usage-countries.tsv", sep = "\t", quote = FALSE)
