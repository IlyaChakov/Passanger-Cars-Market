...
df <- read_csv("Исходные Данные\\Продажи\\World Motor Vehicle Sales by Country and Type.csv")
...
fwrite(df_long, file = "Обработанные Данные\\Продажи\\sales-countries.tsv", sep = "\t", quote = FALSE)
